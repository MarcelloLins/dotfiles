...
function agnoster::context -d "Information that comes on the left, before the first light blue segment"
    # information about color can be found at set_color --help
...
function agnoster::dir -d 'Print current working directory (Light blue bar that comes after the segment)'
